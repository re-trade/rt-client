      ...
      <div className="flex flex-col space-y-3">
        ...
        <div className="space-y-2 pl-2 border-l-2 border-[#FFD2B2]">
          ...
          <div className="flex items-start space-x-2">
            ...
            <p className="text-sm text-[#525252] font-['Reddit_Sans']">{address.phoneNumber}</p>
          </div>

          <div className="flex items-start space-x-2">
            <MapPin className="w-4 h-4 text-[#121212] mt-0.5" />
            <div>
              <p className="text-sm text-[#525252] font-['Reddit_Sans']">{address.addressLine}</p>
              <p className="text-sm text-[#525252] font-['Reddit_Sans']">
        ...
        <div className="flex space-x-2 pt-2 mt-2 border-t border-[#525252]/20">
          <button
            ...
            className="flex items-center bg-[#FFD2B2] text-[#121212] px-3 py-1.5 rounded-lg text-sm hover:bg-[#FFBB99] transition font-medium font-['Reddit_Sans']"
          >
          ...
          <button
            ...
            className="flex items-center bg-white border border-[#525252]/20 text-[#121212] px-3 py-1.5 rounded-lg text-sm hover:bg-red-50 hover:border-red-300 hover:text-red-600 transition font-medium font-['Reddit_Sans']"
          >
