...
import { Star, ThumbsUp, ShoppingBag, Calendar, MessageCircle, ChevronDown, ChevronUp } from 'lucide-react';
...
const mockReviews = [
  {
    ...
    product: {
      ...
      thumbnailUrl: "https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=100&h=100&fit=crop"
    },
    isVerifiedPurchase: true,
    content: "Sản phẩm tuyệt vời! Chất lượng camera rất tốt, pin trâu, thiết kế sang trọng. Mình rất hài lòng với mua hàng này. Shop giao hàng nhanh, đóng gói cẩn thận.",
    author: {
      authId: "user-1",
      name: "Nguyễn Văn An",
    ...
    reply: {
      content: "Cảm ơn bạn đã tin tưởng và lựa chọn sản phẩm của chúng tôi! Chúc bạn sử dụng sản phẩm vui vẻ.",
  ...
  },
  {
    ...
    product: {
      ...
      thumbnailUrl: "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=100&h=100&fit=crop"
    },
    isVerifiedPurchase: true,
    content: "Laptop rất nhẹ và mạnh mẽ. Hiệu năng M2 thật sự ấn tượng, pin sử dụng cả ngày không cần sạc. Thiết kế đẹp, bàn phím gõ rất êm. Đáng đồng tiền bát gạo!",
    author: {
      authId: "user-2",
      name: "Trần Thị Bình",
    ...
    imageUrls: [],
    reply: {
      content: "Rất vui khi bạn hài lòng với sản phẩm. Chúng tôi luôn cam kết mang đến những sản phẩm chất lượng tốt nhất!",
  ...
  },
  {
    ...
    product: {
      ...
      thumbnailUrl: "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=100&h=100&fit=crop"
    },
    isVerifiedPurchase: false,
    content: "Điện thoại tốt nhưng giá hơi cao. Camera zoom 100x thật sự ấn tượng, màn hình sắc nét. Tuy nhiên pin hơi yếu khi sử dụng nhiều. Nhìn chung vẫn là một sản phẩm đáng mua.",
    author: {
      authId: "user-3",
      name: "Lê Minh Châu",
  ...
  },
  {
    ...
    product: {
      ...
      thumbnailUrl: "https://images.unsplash.com/photo-1600294037681-c80b4cb5b434?w=100&h=100&fit=crop"
    },
    isVerifiedPurchase: true,
    content: "Chất lượng âm thanh tuyệt vời, chống ồn rất hiệu quả. Kết nối với iPhone rất mượt mà. Hộp sạc nhỏ gọn, tiện lợi. Giá hơi đắt nhưng xứng đáng với chất lượng.",
    author: {
      authId: "user-4",
      name: "Phạm Đức Thành",
  ...
  },
  {
    ...
    product: {
      ...
      thumbnailUrl: "https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=100&h=100&fit=crop"
    },
    isVerifiedPurchase: true,
    content: "Hiệu năng mạnh mẽ, màn hình đẹp. Rất phù hợp cho công việc thiết kế và học tập. Apple Pencil hoạt động mượt mà. Tuy nhiên giá khá cao so với mặt bằng chung.",
    author: {
      authId: "user-5",
      name: "Hoàng Thị Mai",
    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="space-y-6">
        {mockReviews.map((review) => {
          ...
          return (
            <div key={review.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-200">
              ...
              <div className="p-6">
                ...
                <div className="flex items-start gap-4 mb-4">
                  <img
                    src={review.author.avatarUrl || `https://ui-avatars.com/api/?name=${encodeURIComponent(review.author.name)}&background=6366f1&color=fff`}
