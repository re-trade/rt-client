          ...
          <div className="fixed inset-0 z-50 overflow-auto bg-black/50 flex items-center justify-center animate-in fade-in duration-300">
            <div className="bg-white rounded-xl shadow-xl border border-gray-200 max-w-lg w-full mx-4 relative animate-in slide-in-from-bottom-4 fade-in duration-300">
              <div className="flex justify-between items-center border-b border-gray-200 p-4">
                <h3 className="text-lg font-bold text-gray-900">Tắt xác thực hai yếu tố</h3>
              ...
              <div className="p-6">
                {success ? (
                  <div className="flex flex-col items-center gap-4 p-6 bg-green-50 rounded-lg border border-green-100">
                    ...
                    <h3 className="text-lg font-medium text-gray-800">2FA đã được tắt!</h3>
                  ...
                  <>
                    <div className="bg-gradient-to-r from-[#FEE2E2] to-[#FECACA] border border-[#FCA5A5] p-4 rounded-md mb-6 flex items-start gap-3 shadow-sm animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 py-3 border border-gray-300 bg-white text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent shadow-sm transition-all duration-300 hover:border-red-300"
                    ...
                    <div className="flex gap-3">
                      <button
                        className="flex-1 px-4 py-3 rounded-md text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 transition-all duration-300 border border-gray-200"
                        onClick={() => setShowDisable(false)}
                      >
                        Hủy
                      </button>
                      <button
                        className="flex-1 px-4 py-3 rounded-md text-sm font-medium bg-gradient-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 transition-all duration-300 disabled:opacity-50 flex items-center justify-center shadow-sm hover:shadow-md"
