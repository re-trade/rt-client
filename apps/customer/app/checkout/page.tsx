...
import { IconAlertTriangle, IconCheck, IconMapPin, IconCreditCard } from '@tabler/icons-react';
...
const CheckoutPage: React.FC = () => {
    ...
    const canCheckout = productDetail && !productError && selectedAddressId && selectedPaymentMethodId && !isProcessing;
        ...
        <section className="bg-gradient-to-br from-orange-25 via-orange-50 to-orange-25 py-6 md:py-12 lg:py-20 min-h-screen">
                                    ...
                                    <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">{selectedAddress.customerName} - {selectedAddress.phone}</p>
                                                <p className="text-sm text-gray-600">{selectedAddress.addressLine}, {selectedAddress.ward}, {selectedAddress.district}, {selectedAddress.state}, {selectedAddress.country}</p>
                                ...
                                {isLoadingMethods ? (
                                    ...
                                    <div className="space-y-3">
                                        {paymentMethods.map((method) => (
                                            <div
                                                key={method.id}
                                                className={`p-4 border rounded-lg cursor-pointer transition-all ${selectedPaymentMethodId === method.id
                            ...
                            <div className="rounded-xl border border-orange-100 bg-white shadow-lg overflow-hidden">
                                ...
                                <div className="p-4 md:p-6 space-y-4">
                                    ...
                                    <button
                                        ...
                                        className={`w-full mt-6 font-semibold py-4 px-6 rounded-lg shadow-lg transition-all duration-200 flex items-center justify-center gap-3 ${canCheckout
            ...
            >
                <div className="p-6 text-center">
                    ...
                    {orderSuccess ? (
                        <div>
                            <h3 className="mb-2 text-xl font-bold text-gray-900">Đơn hàng đã được tạo thành công!</h3>
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-lg font-medium transition-colors ${orderSuccess ? 'bg-green-600 hover:bg-green-700 text-white' : 'bg-red-600 hover:bg-red-700 text-white'
                            }`}
                    >
