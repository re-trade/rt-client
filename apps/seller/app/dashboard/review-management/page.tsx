...
const mockReviews: Review[] = [
  ...
  },
  {
    ...
    content: "Áo khoác ấm, thiết kế đơn giản. Tuy nhiên chất liệu hơi thô, không mềm như mong đợi. Khóa kéo hơi cứng.",
...
export default function ReviewsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ReviewTable reviews={filteredReviews} onViewDetail={handleViewDetail} onReply={handleReply} />

      <ReviewDetailDialog open={isDetailOpen} onOpenChange={setIsDetailOpen} review={selectedReview} />
