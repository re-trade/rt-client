            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{new Date(selectedRevenue.date).toLocaleDateString("vi-VN")}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium text-red-600">{selectedRevenue.commission.toLocaleString("vi-VN")}đ</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Doanh thu thực</p>
                  <p className="font-medium text-green-600">{selectedRevenue.netRevenue.toLocaleString("vi-VN")}đ</p>
                </div>
                <div>
