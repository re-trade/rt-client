...
import { IconAlertOctagon, IconHome, IconMail, IconRefresh } from '@tabler/icons-react';
          ...
          <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="p-6 bg-white rounded-2xl shadow-lg border border-red-200 animate-pulse">
                    <IconAlertOctagon size={48} className="text-red-500" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8 space-y-4">
              ...
              <p className="text-lg text-gray-600 max-w-md mx-auto leading-relaxed">
                Đã xảy ra lỗi nghiêm trọng. Chúng tôi đã ghi nhận sự cố này và đang khắc phục.
              </p>
            ...
            <div className="bg-white p-6 rounded-xl border border-orange-200 shadow-md">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-semibold text-gray-800">Cần hỗ trợ khẩn cấp?</h3>
              </div>

              <p className="text-gray-600 text-sm mb-4">
                Vui lòng liên hệ ngay với đội hỗ trợ kỹ thuật của chúng tôi:
              </p>
            ...
            <div className="mt-8 pt-6 border-t border-orange-200">
              <div className="inline-block text-2xl font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
