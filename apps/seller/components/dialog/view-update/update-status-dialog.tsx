...
interface UpdateStatusDialogProps {
  ...
  order: Order | null
  onUpdateStatus: (orderId: string, newStatus: Order["orderStatus"], trackingNumber?: string, notes?: string) => void
}

export function UpdateStatusDialog({ open, onOpenChange, order, onUpdateStatus }: UpdateStatusDialogProps) {
