    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center">
        <Button
          ...
          className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white px-12 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
        >
