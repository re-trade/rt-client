...
export const walletApi = {
    async getWalletBySeller(): Promise<WalletResponse> {
        const response = await authApi.default.get<IResponseObject<WalletResponse>>(`/wallets/me/balance`);
    ...
    async getWithdrawHistory(
        ...
        const response = await authApi.default.get<IResponseObject< WithdrawHistoryResponse[]>>(`/wallets/me/withdraw`, {
            params: {
                page,
                size,
                ...(query ? { query } : {}),
