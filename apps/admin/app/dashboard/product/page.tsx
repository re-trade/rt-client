...
import { useProductManager, TFilterSelected } from "@/hooks/use-product-manager"
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
        ...
        <div className="text-center">
          <div className="text-3xl font-bold text-gray-800 mb-1">{totalValue.toLocaleString("vi-VN")} ₫</div>
...
const AdvancedFilters = ({
  ...
  handleSelectedFilterChange: (key: keyof TFilterSelected, value: string | string[] | number | number[]) => void
  filter: any
      ...
      <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-end">
        ...
        <div>
          <Select
            ...
            onValueChange={(value) => handleSelectedFilterChange("states", value === "all" ? [] : [value])}
          >
            <SelectTrigger>
        ...
        <div>
          <Select
            ...
            onValueChange={(value) => handleSelectedFilterChange("categories", value === "all" ? [] : [value])}
          >
            <SelectTrigger>
        ...
        <div>
          <Select
            ...
            onValueChange={(value) => handleSelectedFilterChange("brands", value === "all" ? [] : [value])}
          >
            <SelectTrigger>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="px-2 py-1 border border-gray-300 rounded text-xs">{product.brand}</div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {product.tags.map((tag: string, index: number) => (
                    <div key={index} className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs">
                      {tag}
                    </div>
                  ))}
                </div>
...
export default function ProductManagementPage() {
  ...
  const handleGoToPage = (newPage: number) => {
    if (typeof goToPage === "function") {
      ...
      console.error("goToPage is not a function:", goToPage)
    }
  }
            ...
            {maxPage > 1 && (
              <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="outline" size="sm" onClick={() => goToPage(page + 1)} disabled={page >= maxPage}>
                    Sau
