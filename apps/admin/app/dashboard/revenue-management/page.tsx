...
export default function RevenueManagementPage() {
  ...
  const revenueGrowth = previousData.length >= 2 && previousData[0] && previousData[1]
    ? ((previousData[1].revenue - previousData[0].revenue) / previousData[0].revenue) * 100
    : 0
  const ordersGrowth = previousData.length >= 2 && previousData[0] && previousData[1]
    ? ((previousData[1].orders - previousData[0].orders) / previousData[0].orders) * 100
    : 0
  const customersGrowth = previousData.length >= 2 && previousData[0] && previousData[1]
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-muted-foreground">Giá trị đơn hàng trung bình</p>
