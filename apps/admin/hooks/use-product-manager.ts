...
const useProductManager = () => {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      if (selectedFilter.states.length) selectedFilter.states.forEach((s) => params.append("state", s))
      if (selectedFilter.categories.length) selectedFilter.categories.forEach((c) => params.append("categoryId", c))
      if (selectedFilter.brands.length) selectedFilter.brands.forEach((b) => params.append("brand", b))
